...
import cn.easemob.redpacketui.widget.ChatRowRedPacket;
import cn.easemob.redpacketui.widget.ChatRowRedPacketAck;
...
import cn.hyphenate.easeui.ui.EaseChatFragment;
import cn.hyphenate.easeui.widget.chatrow.EaseChatRow;
import cn.hyphenate.easeui.widget.chatrow.EaseCustomChatRowProvider;
import cn.hyphenate.easeui.widget.emojicon.EaseEmojiconMenu;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragment.EaseChatFragmentHelper {
    ...
    protected void registerExtendMenuItem() {
        ...
        //extend menu items
        inputMenu.registerExtendMenuItem(cn.ucai.superwechat.R.string.attach_video, cn.ucai.superwechat.R.drawable.em_chat_video_selector, ITEM_VIDEO, extendMenuItemClickListener);
        inputMenu.registerExtendMenuItem(cn.ucai.superwechat.R.string.attach_file, cn.ucai.superwechat.R.drawable.em_chat_file_selector, ITEM_FILE, extendMenuItemClickListener);
        if(chatType == Constant.CHATTYPE_SINGLE){
            inputMenu.registerExtendMenuItem(cn.ucai.superwechat.R.string.attach_voice_call, cn.ucai.superwechat.R.drawable.em_chat_voice_call_selector, ITEM_VOICE_CALL, extendMenuItemClickListener);
            inputMenu.registerExtendMenuItem(cn.ucai.superwechat.R.string.attach_video_call, cn.ucai.superwechat.R.drawable.em_chat_video_call_selector, ITEM_VIDEO_CALL, extendMenuItemClickListener);
        }
        //聊天室暂时不支持红包功能
        //red packet code : 注册红包菜单选项
        if (chatType != Constant.CHATTYPE_CHATROOM) {
            inputMenu.registerExtendMenuItem(cn.ucai.superwechat.R.string.attach_red_packet, cn.ucai.superwechat.R.drawable.em_chat_red_packet_selector, ITEM_RED_PACKET, extendMenuItemClickListener);
        }
        //end of red packet code
    }
    ...
    public void onEnterToChatDetails() {
        if (chatType == Constant.CHATTYPE_GROUP) {
            ...
            if (group == null) {
                Toast.makeText(getActivity(), cn.ucai.superwechat.R.string.gorup_not_found, Toast.LENGTH_SHORT).show();
                return;
            }
...
//        MFGT.gotoFriendProfile(getActivity(),SuperWeChatHelper.getInstance().getAppContactList().get(username));
    ...
    protected void startVoiceCall() {
        if (!EMClient.getInstance().isConnected()) {
            Toast.makeText(getActivity(), cn.ucai.superwechat.R.string.not_connect_to_server, Toast.LENGTH_SHORT).show();
        } else {
