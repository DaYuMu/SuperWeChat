...
public class ChatRoomDetailsActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		RelativeLayout blockGroupMsgLayout = (RelativeLayout) findViewById(cn.ucai.superwechat.R.id.rl_switch_block_groupmsg);
		RelativeLayout showChatRoomIdLayout = (RelativeLayout) findViewById(cn.ucai.superwechat.R.id.rl_group_id);
		RelativeLayout showChatRoomNickLayout = (RelativeLayout) findViewById(cn.ucai.superwechat.R.id.rl_group_nick);
		RelativeLayout showChatRoomOwnerLayout = (RelativeLayout) findViewById(cn.ucai.superwechat.R.id.rl_group_owner);
		TextView chatRoomIdTextView = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_group_id);
		TextView chatRoomNickTextView = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_group_nick_value);
		TextView chatRoomOwnerTextView = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_group_owner_value);
		
		findViewById(cn.ucai.superwechat.R.id.rl_search).setVisibility(View.GONE);
		...
		chatRoomIdTextView.setText(getResources().getString(cn.ucai.superwechat.R.string.chat_room) + " ID："+roomId);
		...
		adapter = new GridAdapter(this, cn.ucai.superwechat.R.layout.em_grid, memberList);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case cn.ucai.superwechat.R.id.clear_all_history: // clear conversation history
