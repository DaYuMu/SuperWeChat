...
public class PickContactNoCheckboxActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.superwechat.R.layout.em_activity_pick_contact_no_checkbox);
		...
		getContactList();
		// set adapter
		contactAdapter = new EaseContactAdapter(this, cn.ucai.superwechat.R.layout.ease_row_contact, contactList);
