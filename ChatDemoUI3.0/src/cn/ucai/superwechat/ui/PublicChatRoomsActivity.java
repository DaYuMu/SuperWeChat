...
public class PublicChatRoomsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		etSearch = (EditText)findViewById(cn.ucai.superwechat.R.id.query);
		ibClean = (ImageButton)findViewById(cn.ucai.superwechat.R.id.search_clear);
		etSearch.setHint(cn.ucai.superwechat.R.string.search);
		...
		TextView title = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_title);
