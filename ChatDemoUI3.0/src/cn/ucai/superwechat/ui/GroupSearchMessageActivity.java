...
public class GroupSearchMessageActivity extends BaseActivity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.ucai.superwechat.R.layout.em_activity_group_search_message);
        
        query = (EditText) findViewById(cn.ucai.superwechat.R.id.query);
        // clear button
        clearSearch = (ImageButton) findViewById(cn.ucai.superwechat.R.id.search_clear);
        listView = (ListView) findViewById(cn.ucai.superwechat.R.id.listview);
        TextView emptyView = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_no_result);
        listView.setEmptyView(emptyView);
        emptyView.setVisibility(View.INVISIBLE);
        TextView cancleView = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_cancel);
        searchView = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_search);
        ...
        query.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                searchView.setText(String.format(getString(cn.ucai.superwechat.R.string.search_contanier), s));
            }
        });
    ...
    private void searchMessages(){
        ...
        pd.setMessage(getString(cn.ucai.superwechat.R.string.searching));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
        case cn.ucai.superwechat.R.id.tv_cancel:
            finish();
            break;
        case cn.ucai.superwechat.R.id.tv_search:
            hideSoftKeyboard();
            searchMessages();
            break;
        default:
    ...
    private class SearchedMessageAdapter extends ArrayAdapter<EMMessage> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(cn.ucai.superwechat.R.layout.em_row_search_message, parent, false);
            }
