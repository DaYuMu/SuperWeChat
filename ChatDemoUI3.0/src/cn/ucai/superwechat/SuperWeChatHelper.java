...
public class SuperWeChatHelper {
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                if(user != null){
                    if(EaseAtMessageHelper.get().isAtMeMsg(message)){
                        return String.format(appContext.getString(cn.ucai.superwechat.R.string.at_your_in_group), user.getNick());
                    }
                    return user.getNick() + ": " + ticker;
                }else{
                    if(EaseAtMessageHelper.get().isAtMeMsg(message)){
                        return String.format(appContext.getString(cn.ucai.superwechat.R.string.at_your_in_group), message.getFrom());
                    }
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onApplicationAccept(String groupId, String groupName, String accepter) {
            ...
            String st4 = appContext.getString(cn.ucai.superwechat.R.string.Agreed_to_your_group_chat_application);
        ...
        public void onAutoAcceptInvitationFromGroup(String groupId, String inviter, String inviteMessage) {
            // got an invitation
            String st3 = appContext.getString(cn.ucai.superwechat.R.string.Invite_you_to_join_a_group_chat);
            EMMessage msg = EMMessage.createReceiveMessage(Type.TXT);
            msg.setChatType(ChatType.GroupChat);
            msg.setFrom(inviter);
            msg.setTo(groupId);
